								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-header">
											Resultados de usuarios registrados
										</div>
												...
												<tbody>
													<tr>                                                                                                
														...
														<td>Nombres</td>
                                                                                                                <td>Apellidos</td>
                                                                                                                <td>Cargo</td>
                                                                                                                <td><span class="label label-sm label-success">Telefono</span></td>
                                                                                                                <td><span class="label label-sm label-success">Correo</span></td>
														<td>2017-12-31</td>
